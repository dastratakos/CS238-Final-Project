...
def load_level(level_id, num_manual_players=1, num_ai_players=0):
    ...
    floor = ElementSprite(
        (SCREEN_SIZE[0] / 2, BLOCK_SIZE * (SCREEN_BLOCKS[1] - 4)),
        ...
        for element in elements:
            if pygame.sprite.collide_rect(player, element):
                if element.collision_type in [
                    ...
                    if not player.reversed_gravity:
                    ...
                    if element.action_type == ActionType.FLY:
                        ...
                        player.reversed_gravity = not player.reversed_gravity
                    ...
                    if pygame.key.get_pressed()[pygame.K_SPACE]:
                        ...
                        # player.position.y += player.velocity.y
                elif isinstance(element, CollisionType.END):
                    print("You win!")
...
def play(
    ...
    tiles = []
    for i in range(2):
        print("Making tile", (i * 800 + 800 / 2, 800 / 2))
        tiles.append(TiledSprite(
            (i * 800, 0),
    ...
    while not go_to_pause:
        ...
        # 1. Update player(s), elements, floor, camera, background, and ground
        ...
        for player in players:
            for particle in player.particles:
                pygame.draw.rect(alpha_surface, (255, 255, 255), particle.rect)
